...
const CodeOfConduct = () => (
  <Layout>
    <PageSEO title="Code of Conduct" description="Standards for respectful, safe, and mission-driven participation at Youth of Peel." path="/code-of-conduct" />
    <section className="bg-primary page-header">
      <div className="container-narrow">
        ...
        <p className="text-lg text-primary-foreground/80">Standards for respectful, safe, and mission-driven participation at YOP.</p>
      </div>
    </section>
    ...
    <section className="section-padding bg-card">
      <div className="container-narrow space-y-8">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }}>
          ...
          <p className="text-foreground/80 leading-relaxed">Represent YOP responsibly in meetings, events, and digital spaces. Harassment, hate speech, and intimidation are not tolerated.</p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.24 }}>
          ...
          <p className="text-foreground/80 leading-relaxed">To report a concern, email <a className="text-secondary font-semibold hover:underline" href="mailto:info.youthofpeel@gmail.com">info.youthofpeel@gmail.com</a>.</p>
        </motion.div>
      </div>
    </section>
  </Layout>
